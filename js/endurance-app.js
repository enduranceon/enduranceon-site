// Aplicativo de Testes de Lactato - Versão Endurance On
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    formTeste.addEventListener('submit', (e) => {
        ...
        const testeData = {
            ...
            tipoTeste: 'endurance' // Identificador para o tipo de teste
        };
...
function gerarRelatorio(data) {
    ...
    window.open(`report-endurance.html?data=${encodedData}`, '_blank');
}
